...
The ecl-core package SHALL contain a `knowledge/` module with structured ECL reference documentation condensed from the official ECL specification and grammar repository examples. This content SHALL be usable by the LSP server (hover docs, completion context) and other consumers.
