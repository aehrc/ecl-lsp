...
import { getRefactoringActions, resolveAddDisplayTerms, resolveUnifiedSimplify } from 'ecl-core';
import type { CoreCodeAction, CoreTextEdit, ITerminologyService } from 'ecl-core';
