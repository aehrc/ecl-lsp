...
// This is the monaco >= 0.56.0 specifier; 0.55.x used
// `monaco-editor/esm/vs/editor/editor.worker`. See ecl-editor-core's README.
...
// tests need public network access at run time, and they exercise a pinned CDN
// version rather than the one this repo depends on - so a monaco upgrade could
// never be validated here. See #84.
